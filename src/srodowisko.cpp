...
void losowoRozmiescWewnetrznie(Srodowisko &ekoSystem,
                              unsigned int ile,
...
void losowoRozmiesc(Srodowisko &ekoSystem,
                    ...
                    RodzajMieszkanca rodzaj)
{
    losowoRozmiescWewnetrznie(ekoSystem, ile, rodzaj);
}

void uruchomSymulacje(const KonfiguracjaStartowa &konfiguracja)
{
    Srodowisko ekoSystem(konfiguracja.wiersze,
                         konfiguracja.kolumny,
                         konfiguracja.glebokosc);
    losowoRozmiescWewnetrznie(ekoSystem, konfiguracja.glony, GLON);
    losowoRozmiescWewnetrznie(ekoSystem, konfiguracja.grzyby, GRZYB);
    losowoRozmiescWewnetrznie(ekoSystem, konfiguracja.bakterie, BAKTERIA);
